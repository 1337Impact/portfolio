...
export default function Experience() {
  ...
  return (
    <section id="experience" ref={ref} className="mt-10 scroll-mt-28">
      <div className="overflow-y-hidden mb-28 sm:mb-40">
          ...
          {experiencesData.map((item, index) => (
            <React.Fragment key={index}>
              ...
              >
                ...
                <p className="!font-bold !text-[13px] !mt-0 text-primary">
                  {item.location}
                </p>
